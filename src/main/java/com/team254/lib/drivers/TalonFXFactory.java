...
public class TalonFXFactory {
    ...
    // create a CANTalon with the default (out of the box) configuration
    public static WPI_TalonFX createWPIDefaultTalon(int id) {
            return createWPITalon(id, kDefaultConfiguration);
    }

    public static WPI_TalonFX createWPIPermanentSlaveTalon(int id, int master_id) {
            final WPI_TalonFX talon = createWPITalon(id, kSlaveConfiguration);
            talon.set(ControlMode.Follower, master_id);
            return talon;
    }

    public static WPI_TalonFX createWPITalon(int id, Configuration config) {
            WPI_TalonFX talon = new WPI_TalonFX(id, "rio");
            talon.set(ControlMode.PercentOutput, 0.0);
